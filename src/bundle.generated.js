...
function renderHistoryList(history) {
  ...
  return '<div class="card p-4 text-sm"><div class="text-gray-400 mb-2 text-xs uppercase tracking-wider font-semibold">Recent Audits</div>' +
    history.slice(0, 5).map(function(e) {
      ...
      return '<div class="flex justify-between items-center py-2 px-3 card-hover rounded-lg cursor-pointer" onclick="document.getElementById('url-input').value='' + e.url.replace(/'/g, "\\'") + '';window.startAudit()"><span class="text-gray-300 text-sm truncate mr-2">' + e.url + '</span><span class="font-bold text-sm ' + levelCls + '">' + e.score + '</span></div>';
    }).join("") +
    '</div>';
}
...
// --- Global assignments ---
if (typeof doExport !== "undefined" && typeof window.doExport === "undefined") window.doExport = doExport;
if (typeof exportHtml !== "undefined" && typeof window.exportHtml === "undefined") window.exportHtml = exportHtml;
if (typeof getElementById !== "undefined" && typeof window.getElementById === "undefined") window.getElementById = getElementById;
if (typeof reload !== "undefined" && typeof window.reload === "undefined") window.reload = reload;
if (typeof renderComparisonPanel !== "undefined" && typeof window.renderComparisonPanel === "undefined") window.renderComparisonPanel = renderComparisonPanel;
if (typeof renderHistory !== "undefined" && typeof window.renderHistory === "undefined") window.renderHistory = renderHistory;
if (typeof renderReport !== "undefined" && typeof window.renderReport === "undefined") window.renderReport = renderReport;
if (typeof replace !== "undefined" && typeof window.replace === "undefined") window.replace = replace;
if (typeof runComparison !== "undefined" && typeof window.runComparison === "undefined") window.runComparison = runComparison;
if (typeof showBatchInput !== "undefined" && typeof window.showBatchInput === "undefined") window.showBatchInput = showBatchInput;
if (typeof showComparison !== "undefined" && typeof window.showComparison === "undefined") window.showComparison = showComparison;
if (typeof startAudit !== "undefined" && typeof window.startAudit === "undefined") window.startAudit = startAudit;
if (typeof startBatchAudit !== "undefined" && typeof window.startBatchAudit === "undefined") window.startBatchAudit = startBatchAudit;