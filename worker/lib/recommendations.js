...
function getFixSuggestion(dimension, checkId) {
  const fixes = {
    ...
    citationReadiness: {
      ...
      'cite-tags': 'Use <cite> and <blockquote cite=""> tags for proper citation markup',
      'data-tables': 'Present comparative data in HTML <table> format for AI extraction',
      'faq-schema': 'Add FAQPage JSON-LD schema or <details>/<summary> Q&A format',
      'comparisons': 'Include comparison tables or benchmark data (vs, better than, faster)',
      'case-studies': 'Add real-world case studies with before/after metrics',
      'definitions': 'Use <dfn> or <dl> tags for key term definitions',
      'numbered-steps': 'Format instructions as <ol> numbered lists',
      'images-alt': 'Add descriptive alt text to all images (avoid generic descriptions)',
      'internal-links': 'Add 3+ internal contextual links to related content',
      'timestamps': 'Add <time datetime=""> tags or display publication/update dates',
      'blockquote-count': 'Add <blockquote> elements for quotable expert passages — AI engines extract these as citable snippets',
      'authoritative-links': 'Link to 2+ authoritative sources (.org, W3C, Mozilla, Wikipedia, academic institutions)',
      'article-schema': 'Add Article or BlogPosting JSON-LD schema to blog posts with headline, author, datePublished',
      'passage-density': 'Include at least one paragraph with 150+ words of dense, factual information for AI extraction',
      'connective-words': 'Use logical connectives (however, moreover, therefore, furthermore) to improve content fluency and AI comprehension',
      'question-headings': 'Add question-format headings (e.g., "What is GEO?") to capture voice search and AI Q&A queries',
      'reference-section': 'Add a References or Further Reading section with cited sources to boost attribution completeness',
      'nuance-signals': 'Include limitations, caveats, and trade-offs to demonstrate honesty and expertise (EEAT signal)',
      'social-proof': 'Add testimonials, reviews, or aggregate ratings with schema markup for social proof',
      'accessibility-aria': 'Use semantic HTML5 landmarks (<header>, <nav>, <main>, <footer>) or ARIA role attributes for accessibility',
    },
    discoveryEndpoints: {
